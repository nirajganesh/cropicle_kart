                                            ...
                                            <?php foreach($data as $d){?>
                                                <tr>
                                                    ...
                                                    <td class=''>
                                                        ...
                                                        <a href="<?=base_url('delete-cat/').$d->id?>"  onclick="return confirm('Delete this category?');" class="" data-toggle="tooltip" data-placement="top" title="Delete location"><i class="badge-circle badge-circle-light-secondary text-danger bx bx-trash font-medium-1"></i></a>
                                                    </td>
                                                </tr>
                                            <?php }?>
                                            </tbody>
